...
///see here
	...
	public  Traveller getTravellerById(long travellerId) {
		return getAllTraveller().stream().filter(e->e.getTravellerId()==travellerId).collect(Collectors.toList()).get(0);
	}
	...
	public List<Passenger> getAllPassengers(){
		...
		List<Passenger> passengers=restTemplate.getForObject("http://localhost:8082/weekendtrip/traveller/getallpassenger", List.class);
		log.info("{}"+passengers);
		return passengers;
